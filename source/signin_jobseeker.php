<?php
    ...
    if(isset($_POST['signin'])){
        ...
        $statement = (new JobSeekerController())->signin($email, $password);
...
<html lang="en">
  <head>
    ...
    <body style="height: 100%">
        <div class="container" style="background: url('./assets/images/img_register/background_singin.png'); background-size: cover; width: 100%; height: 100%">
            ...
            <form action="" class="form-signin" method="POST" style="display: flex; align-items: center; justify-content: center;">    
                <table>
                    <tr>
                        <td colspan="2">
                            <div class="header-container" style="display: flex; justify-content: center; width: 100%; height: 50%">
                                <img src="./assets/images/Logo.png" alt="" class="register-header-logo" width=50% height=50%/>
                            </div>
                        </td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        ...
                        <td>
                            <input type="text" name="email" id="inp_email" placeholder="Nhập email tại đây"/>
                        </td>
                    </tr>
                    <tr>
                        <td>
                    ...
                    <tr>
                        <td colspan="2">
                            <p> Chưa có tài khoản? <a href="./registerForm_jobseeker.php?page=job"><u><b>Đăng kí ngay</b></u></a ></p>
                        </td>
                    </tr>
                    <tr>
                        <td colspan="2">
